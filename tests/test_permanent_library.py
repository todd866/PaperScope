...
def _run(root: Path, *args):
    env = {
        ...
        # snapshot commits via git; provide an identity so the test is
        # hermetic on machines (e.g. CI runners) with no gitconfig
        "GIT_AUTHOR_NAME": "paperscope-test",
        "GIT_AUTHOR_EMAIL": "test@example.invalid",
        "GIT_COMMITTER_NAME": "paperscope-test",
