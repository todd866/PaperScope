...
- `effective`   — AI JSONL + overrides -> decisions-of-record (human flip wins,
                  AI original preserved in provenance). This is what PRISMA,
                  aggregation, and the review site consume.
"""
