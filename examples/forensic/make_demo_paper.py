...
and its Results section embeds one of each thing the forensic CLI detects:
  ...
  5. a Table 1 whose treatment mean fails GRIM: mean 18.75 with n = 22 is
     unreachable by any integer-valued sum under either round-half OR
     truncation (412.5 lands between the achievable 18.7273 and 18.7727) --
     a robust, convention-independent GRIM failure caught in table mode via
     table1.json.
...
PAGE2 = [
    ...
    ("helv", 10, "  ------------------------------"),
    ("helv", 10, "  Treatment   22    18.75   5.31"),
