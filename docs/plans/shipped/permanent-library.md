...
**Status:** Shipped 2026-05-23 (pattern + reference skeleton live in
`docs/permanent-library.md` and `examples/permanent-library/`)
**Date:** 2026-05-23
...
2. **`examples/permanent-library/`** — sanitized, generic reference skeleton the assistant
   copies into a user-chosen path (default `~/paper-library`) and adapts:
